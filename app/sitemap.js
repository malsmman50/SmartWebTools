...
export default function sitemap() {
  ...
  const routes = [
    ...
    // --- Added: real, working pages that existed in app/[lang] but were missing from the sitemap ---
    ...
    { path: '/calculators/currency', changeFrequency: 'daily', priority: 0.8 },
    { path: '/calculators/health/ramadan-hydration', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/calculators/lifestyle/fuel-cost', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/calculators/shopping/customs-duty', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/tools/data-converter', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/tools/hijri-converter', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/tools/image-compressor', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/tools/qibla-compass', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/tools/regex-tester', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/developers', changeFrequency: 'monthly', priority: 0.6 },
    { path: '/compare/sukuk-vs-bonds', changeFrequency: 'monthly', priority: 0.6 },
