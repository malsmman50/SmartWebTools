...
export const SOURCES = {
  ...
  inheritance: {
    ar: {
      ...
      note: 'من يتبع مذهباً آخر في مسألة الجد سيحصل على نتيجة مختلفة — وهذا حقه أن يعلمه. لم تُعرض هذه الحالات على مختص بعد؛ التركة الفعلية تحتاج مفتياً.',
    },
    en: {
      rows: [
      ...
      note: 'Following another school on the grandfather question yields a different split — you are entitled to know that. These cases have not yet been reviewed by a scholar; a real estate needs a qualified mufti.',
    },
  },
